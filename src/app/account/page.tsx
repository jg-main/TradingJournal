...
import { Plus, Edit3, Trash2, User, Building2, Wallet } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-4xl px-8 py-10">
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            Manage your brokerage accounts and linked settings.
          </p>
        </div>
        <Button onClick={openCreate}>
          <Plus className="size-4" />
            ...
            <Table>
              <TableBody>
                {inactiveAccounts.map((account) => (
                  <TableRow key={account.id}>
                    <TableCell className="font-medium text-zinc-500">{account.name}</TableCell>
      ...
      <p className="mt-4 text-xs text-zinc-400">
        Set your default account in{' '}
        <a href="/settings" className="underline hover:text-zinc-600 dark:hover:text-zinc-300">
          Settings
        </a>
        .
      </p>
