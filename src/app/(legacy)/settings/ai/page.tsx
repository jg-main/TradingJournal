...
export default function AiSettingsPage() {
  ...
  // AI has no background-refresh lifecycle (unlike Backup), so raw `loading`
  // is the correct gate for the shared child shell: the full page identity
  // (Back, title, description) stays visible while the form loads.
  return (
    <SettingsChildPage
      title="AI Settings"
      description="Configure AI model providers for trade analysis and grading."
      loading={loading}
      loadingText="Loading AI settings..."
      message={message}
    >
