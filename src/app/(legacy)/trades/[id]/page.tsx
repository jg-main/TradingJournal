...
export default function TradeDetailPage() {
  ...
  const openCorrectExecution = useCallback((execution: Execution) => {
    setCorrectingExecution(execution);
  ...
  return (
    <div className={trade.status === 'open' ? 'td px-8 py-10' : 'mx-auto max-w-4xl px-8 py-10'}>
      ...
      {trade.status === 'open' && (
        <ActivePhaseView
          ...
          levelHistoryEvents={levelHistory}
