...
export const BACKUP_TABLES = [
  ...
  { name: 'trade_assets', label: 'Trade Assets', restoreOrder: 28 },
  { name: 'trade_grades', label: 'Trade Grades', restoreOrder: 29 },
  { name: 'position_price_snapshots', label: 'Position Price Snapshots', restoreOrder: 30 },
  { name: 'trade_assessment_snapshots', label: 'Trade Assessment Snapshots', restoreOrder: 31 },
  { name: 'trade_mistakes', label: 'Trade Mistakes', restoreOrder: 32 },
  { name: 'trade_check_results', label: 'Trade Check Results', restoreOrder: 33 },
  { name: 'watchlist_items', label: 'Watchlist Items', restoreOrder: 34 },
  { name: 'alert_log', label: 'Alert Log', restoreOrder: 35 },
  { name: 'account_transactions', label: 'Account Transactions', restoreOrder: 36 },
  { name: 'account_rollforward', label: 'Account Rollforward', restoreOrder: 37 },
  { name: 'weekly_reviews', label: 'Weekly Reviews', restoreOrder: 38 },
  { name: 'review_action_items', label: 'Review Action Items', restoreOrder: 39 },
  { name: 'dashboard_views', label: 'Dashboard Views', restoreOrder: 40, optionalInExistingBackups: true },
