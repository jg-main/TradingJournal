...
export const PERFORMANCE_WIDGET_REGISTRY: Record<string, PerformanceWidgetDefinition> = {
  ...
  [PERFORMANCE_WIDGET_IDS.DAILY_CUMULATIVE_PNL]: {
    ...
    category: 'chart',
    supportedUnits: ['currency', 'percent', 'r'],
    defaultLayout: { w: 12, h: 6, x: 0, y: 10 },
    minSize: { w: 6, h: 4 },
    maxSize: { w: 12, h: 10 },
    canDuplicate: true,
    defaultVisible: true,
  ...
  [PERFORMANCE_WIDGET_IDS.NET_DAILY_PNL]: {
    ...
    category: 'chart',
    supportedUnits: ['currency', 'percent', 'r'],
    defaultLayout: { w: 12, h: 5, x: 0, y: 16 },
    minSize: { w: 6, h: 4 },
    maxSize: { w: 12, h: 8 },
    canDuplicate: true,
    defaultVisible: true,
  ...
  [PERFORMANCE_WIDGET_IDS.TRADE_DURATION_PERFORMANCE]: {
    ...
    category: 'chart',
    supportedUnits: ['currency', 'percent', 'r'],
    defaultLayout: { w: 6, h: 5, x: 0, y: 21 },
    minSize: { w: 4, h: 4 },
    maxSize: { w: 8, h: 8 },
    canDuplicate: true,
    defaultVisible: true,
  ...
  [PERFORMANCE_WIDGET_IDS.DRAWDOWN_CURVE]: {
    ...
    category: 'chart',
    supportedUnits: ['currency', 'percent'],
    defaultLayout: { w: 6, h: 5, x: 6, y: 21 },
    minSize: { w: 4, h: 4 },
    maxSize: { w: 8, h: 8 },
    canDuplicate: true,
    defaultVisible: true,
  ...
  [PERFORMANCE_WIDGET_IDS.R_DISTRIBUTION]: {
    ...
    defaultLayout: { w: 6, h: 5, x: 0, y: 26 },
    minSize: { w: 4, h: 4 },
    maxSize: { w: 8, h: 8 },
    canDuplicate: true,
    defaultVisible: true,
  ...
  [PERFORMANCE_WIDGET_IDS.PERFORMANCE_BY_SETUP]: {
    ...
    defaultLayout: { w: 6, h: 5, x: 6, y: 26 },
    minSize: { w: 4, h: 4 },
    maxSize: { w: 8, h: 8 },
    canDuplicate: true,
    defaultVisible: true,
