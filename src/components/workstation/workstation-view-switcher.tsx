...
// WorkstationViewSwitcher — view selector for the workstation toolbar
// (M016/S06-T03).
//
...
// with a checkmark on the active view. It mirrors the dashboard ViewSwitcher
// pattern (Radix dropdown-menu primitive, grouped system/user lists) but
// consumes workstation view envelopes (WorkstationView) and uses the
// workstation density styling for the trigger so it sits naturally in the
// .ws toolbar chrome.
//
// Create New View prompts for a name and delegates to onCreateView, which
// the page wires to useWorkstationViews().createView — the new view is
// created from the active view's template and becomes active immediately.
//
 ...
 * checkmark on the active view, plus a "Create New View" action. The
 * trigger shows the active view's name and a chevron.
 */
